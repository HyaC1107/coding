...
const HeavyMyPage = () => {
  ...
  const menuItems = [
    { name: '공지사항', icon: '/images/07-mypage/02-customer/03-notice.png', path: '/heavy/notice', action: null },
    { name: '리뷰관리', icon: '/images/07-mypage/02-customer/04-review.png', path: '/heavy/reviews', action: null },
    ...
    { name: '자주 묻는 질문', icon: '/images/07-mypage/02-customer/11-faq.png', path: '/heavy/qna', action: null },
    { name: '1:1 문의하기/소비자 신고', icon: '/images/07-mypage/02-customer/02-qna.png', path: '/heavy/qna', action: null },
    { name: '회원정보 수정하기', icon: '/images/07-mypage/02-customer/13-info.png', path: '/heavy/profile/edit', action: null },
  ];
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <button
              onClick={() => navigate('/heavy/profile/edit')}
              style={{
