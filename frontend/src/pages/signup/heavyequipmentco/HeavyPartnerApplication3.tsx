...
export default function HeavyPartnerApplication3(): JSX.Element {
  ...
  const handleSubmit = async () => {
    try {
      ...
      formData.append('name', params.name || params.userId || '');
      formData.append('phoneNumber', params.phoneNumber || '01000000000');
      formData.append('type', 'heavy');

      // Company Info
      formData.append('companyName', params.companyName || '');
      formData.append('address', params.address || '');
      formData.append('companyEmail', params.companyEmail || '');
      formData.append('heavyType', params.heavyType || '');
      formData.append('career', params.career || '0');
      formData.append('heavyTON', params.heavyTON || '');
      ...
      // Files
      const addFile = (field: string, asset: any) => {
        if (asset) {
      ...
      addFile('CBPImg', params.CBPImg);
      addFile('personalIdImg', params.personalIdImg);
      addFile('frontImg', params.frontImg);
      addFile('sideImg', params.sideImg);
      addFile('rearImg', params.rearImg);
      addFile('freightCertImg', params.freightCertImg);
      addFile('pilotTrainingCertImg', params.pilotTrainingCertImg);
      ...
      <ScrollView style={styles.rootWrapper}>
        ...
        <View style={[styles.greyBodyWrap, styles.marginBottom]}>
          <View
            ...
            <Text style={styles.basicExposeLoc}>기본 노출지역</Text>
        ...
        <View style={[styles.greyBodyWrap, styles.marginBottom]}>
          <View
            ...
            <Text style={styles.basicExposeLoc}>추가 노출지역</Text>
            <View style={{flexDirection: 'row', alignItems: 'center', gap: 10}}>
              <Image
                style={styles.addLocIcon}
                source={require('@/assets/images/01-login/01-add-button.png')}
        ...
        <View style={[styles.greyBodyWrap, styles.marginBottom]}>
          <View
            ...
            <Text style={{fontSize: responsiveFontSize(1.8)}}>결제 금액</Text>
        ...
        <View style={[styles.greyBodyWrap, styles.marginBottom]}>
          <View
            ...
            <Text style={styles.basicExposeLoc}>자동출금 은행 선택</Text>
          </View>
          <View
            style={{
              flexDirection: 'row',
