...
import ConstructionFinishStatusCard from './ConstructionFinishStatusCard';
...
export default function HeavyConstructionFinishPage(): JSX.Element {
  ...
  const fetchRequests = async () => {
    try {
      ...
      console.error('Failed to fetch finished requests:', error);
