...
export default function ConstructionChatRoom(): JSX.Element {
      ...
      {isOpen && (
        <View
          ...
          <View style={{alignItems: 'center', gap: 10}}>
            <Image source={require('@/assets/images/chat/co-photo.png')} />
            <Text style={{fontSize: responsiveFontSize(1.4)}}>
              사진첨부하기
            </Text>
          </View>
          <View style={{alignItems: 'center', gap: 10}}>
            <Image source={require('@/assets/images/chat/co-docs.png')} />
            <Text style={{fontSize: responsiveFontSize(1.4)}}>견적서보기</Text>
          </View>
          <View style={{alignItems: 'center', gap: 10}}>
            <Image source={require('@/assets/images/chat/customer-out.png')} />
            <Text style={{fontSize: responsiveFontSize(1.4)}}>
              대화방나가기
            </Text>
          </View>
