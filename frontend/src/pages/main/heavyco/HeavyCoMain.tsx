...
import CategoryPopup from '@/pages/popup/CategoryPopup';
import CustomerRentRequestWithDate from '@/pages/popup/CustomerRentRequestWithDate';
import CalendarFilterPopup from '@/pages/popup/schedule/CalendarFilterPopup';
import CalendarOnlyPopup from '@/pages/popup/CalendarOnlyPopup';
import DaySelectPopup from '@/components/popup/DaySelectPopup';
import CalendarSchedulePopup from '@/pages/popup/CalendarSchedulePopup';
...
import CategorySelWarnPopup from '@/pages/popup/warn/CategorySelWarnPopup';
import CancleReqDenyPopup from '@/components/popup/CancelReqDenyPopup';
import CreateReviewPopup from '@/components/popup/CreateReviewPopup';
...
export default function HeavyCoMain(): JSX.Element {
  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
     ...
     {/* <AddressSelectPopup
      ...
      {/* <CalendarFilterPopup /> */}
      {/* <CalendarOnlyPopup /> */}
      {/* <DaySelectPopup handlePopup={handlePopup} /> */}
      {/* <CalendarSchedulePopup /> */}
      {/* <SelectConstructionLocPopup /> */}
      {/* <SelectConstructionSpacePopup /> */}
      {/* <SetPricePopup handlePopup={handlePopup} /> */}
      {/* <CustomerAddrPopup /> */}
      {/* <CalendarWithTimePickerPopup />       */}      
      {/* <SelectCarTypePopup /> */}
      {/* <ConsToolRentNavPopup />        */}
      {/* <HeavyScheduleNavPopup />  */}
      {/* <ConsToolRentNavPopup /> */}
      {/* <ToolRentNavPopup /> */}
      {/* <QnaPopup /> */}
      {/* <HomeDecoPopup /> */}
      {/* <CalendarWithSingleDatepicerPopup
        title={'변경공사 시작하는 날짜와 시간을 선택해주세요'}
      /> */}
      {/* <ConstructionTimeSetPopup /> */} 
      {/* <SelectToolPopup handlePopup={handlePopup} /> */}
