...
import GetRequestListStatusCard from './HeavyUpdateRentStatusCard';
import CalendarOnlyPopup from '@/pages/popup/CalendarOnlyPopup';
import ToolRentNavPopup from '@/pages/popup/ToolRentNavPopup';
import GetHeavyRequestListStatusCard from './HeavyUpdateRentStatusCard';
import HeavyUpdateRentStatusCard from './HeavyUpdateRentStatusCard';
...
export default function HeavyUpdateRentPage(): JSX.Element {
