...
export default function HeavyUpdateRentProfileCard(
    ...
    <View
      ...
      <View
        ...
        <View style={{alignItems: 'center', gap: 15}}>
          <Text style={{fontSize: responsiveFontSize(2)}}>희망장비</Text>
          <Text style={{fontSize: responsiveFontSize(2.2), fontWeight: 'bold'}}>
            고소작업차
          </Text>
        </View>
        <View style={{alignItems: 'center', gap: 10}}>
          <Text style={{fontSize: responsiveFontSize(2)}}>희망차종</Text>
          <Text style={{fontSize: responsiveFontSize(2.2), fontWeight: 'bold'}}>
            1톤
          </Text>
        </View>
