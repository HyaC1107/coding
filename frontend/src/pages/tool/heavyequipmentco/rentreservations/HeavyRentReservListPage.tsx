...
import GetRequestListStatusCard from './HeavyRentReservListStatusCard';
import CalendarOnlyPopup from '@/pages/popup/CalendarOnlyPopup';
import ToolRentNavPopup from '@/pages/popup/ToolRentNavPopup';
import GetHeavyRequestListStatusCard from './HeavyRentReservListStatusCard';
...
export default function HeavyRentReservListPage(): JSX.Element {
