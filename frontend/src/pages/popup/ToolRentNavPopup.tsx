...
export default function ToolRentNavPopup(
        ...
        <View
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(1);
                // data.handleHeader('장비요청');
                navigation.navigate('GetHeavyRequestListPage');
              }}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>장비요청</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(2);
                // data.handleHeader('요청보기');
                navigation.navigate('HeavyRentReservListPage');
              }}>
              <View style={styles.iconWrap}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>임대예약현황</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                ...
                navigation.navigate('HeavyRentSchedulePage');
              }}>
              <View style={styles.iconWrap}>
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(4);
                // data.handleHeader('임대날짜변경요청');
                navigation.navigate('HeavyUpdateRentPage');
              }}>
              <View style={styles.iconWrap}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>임대날짜변경요청</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(5);
                navigation.navigate('HeavyCancelSchedulePage');
              }}>
              <View style={styles.iconWrap}>
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(6);
                navigation.navigate('HeavyRentSuccessPage');
              }}>
              <View style={styles.iconWrap}>
