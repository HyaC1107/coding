...
export default function CalendarPopup({ closePopup,
  openSuccessPopup,
  onSelect
}: {
  closePopup: () => void;
  ...
  return (
    <View style={styles.rootWrapper}>
      <View style={styles.popUpWrap}>
        ...
        <Calendar handleDate={(date) => setSelectedDate(date)} />
        <ScrollView
        ...
        <TouchableWithoutFeedback
          onPress={() => {
            const selectedTime = data.find(v => v.isSelected)?.time || '';
            if (onSelect) {
              onSelect(selectedDate, selectedTime);
            }
            closePopup(); // Close the calendar popup
            if (openSuccessPopup) openSuccessPopup(); // Open the success popup
          }}>
