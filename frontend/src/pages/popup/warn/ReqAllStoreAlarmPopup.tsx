...
export default function ReqAllStoreAlarmPopup(): JSX.Element {
  ...
  const handleConfirm = () => {
    setPopup(false);  // Close the popup // Navigate to the home screen
  };
  useEffect(() => {
    ...
    <View style={showPopup ? styles.rootWrapper : styles.close}>
      <View
        ...
        <View style={{width: '100%', alignItems: 'center', padding: '5%'}}>
          ...
          <TouchableWithoutFeedback onPress={() => setPopup(!showPopup)}>
            <Text style={{color: '#2CB07B', fontSize: 12, paddingTop: '10%'}}>
              확인
            </Text>
          </TouchableWithoutFeedback>
        </View>
