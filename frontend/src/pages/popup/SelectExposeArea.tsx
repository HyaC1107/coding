...
export default function SelectExposeArea(): JSX.Element {
          ...
          <ScrollView style={{width: '100%', flex: 1}}>
            <View style={styles.checkGroupWrap}>
              ...
              <View style={styles.textWrap}>
                <Text style={styles.text}>서울시 마포구 용강동</Text>
              </View>
            </View>
            <View style={styles.checkGroupWrap}>
              <TouchableWithoutFeedback
              ...
              <View style={styles.textWrap}>
                <Text style={styles.text}>서울시 마포구 상수동</Text>
              </View>
            </View>
            <View style={styles.checkGroupWrap}>
              <TouchableWithoutFeedback
            ...
            <View style={styles.checkGroupWrap}>
              ...
              <View style={styles.textWrap}>
                <Text style={styles.text}>서울시 마포구 도화동</Text>
              </View>
            </View>
            <View style={styles.checkGroupWrap}>
              <TouchableWithoutFeedback
