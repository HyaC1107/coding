...
export default function IsWarrentyAvailablePopup(): JSX.Element {
      ...
      <View style={styles.popUpWrap}>
        ...
        <View style={styles.checkGroupWrap}>
          ...
          <View style={styles.textWrap}>
            <Text style={styles.text}>지급보증보험</Text>
          </View>
        </View>
        <View style={styles.checkGroupWrap}>
          <TouchableWithoutFeedback
          ...
          <View style={styles.textWrap}>
            <Text style={styles.text}>계약보증보험</Text>
          </View>
        </View>
        <View style={styles.checkGroupWrap}>
          <TouchableWithoutFeedback
          ...
          <View style={styles.textWrap}>
            <Text style={styles.text}>선금보증보험</Text>
          </View>
        </View>
        <View style={styles.checkGroupWrap}>
          <TouchableWithoutFeedback
          ...
          <View style={styles.textWrap}>
            <Text style={styles.text}>하자보증보험</Text>
          </View>
        </View>
