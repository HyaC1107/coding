  ...
  return (
    <View
      ...
      <View
        ...
        <Text style={{paddingBottom: '1%', fontSize: responsiveFontSize(2)}}>
          정보를 수정하기 위해
        </Text>
        <Text style={{paddingBottom: '2%', fontSize: responsiveFontSize(2)}}>
          비밀번호를 입력해주세요
        </Text>
      </View>
      <View style={{width: '100%', alignItems: 'center'}}>
        <View
          ...
          <Image
            ...
            source={require('@/assets/images/profile-lock.png')}
          />
          <TextInput
            style={{fontSize: responsiveFontSize(1.6)}}
            placeholder="비밀번호를 입력해주세요"
            onChange={e => {
              setPasswd(e.target.toString());
            }}
            onSubmitEditing={() => {
              navigation.navigate('ProfileUpdateForm');
            }}
          />
        </View>
      </View>
