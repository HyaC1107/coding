...
export default function QnAEnrollPage(): JSX.Element {
            ...
            <Text
              style={
                item === 1
                  ...
                  : {color: '#B4B4B4', fontSize: responsiveFontSize(1.6)}
              }>
              문의하기
            </Text>
          </View>
      ...
      {item === 1 && (
        <View style={{padding: '5%', gap: 20}}>
          <View
            ...
            <Text style={{color: '#BDBFC1', fontSize: responsiveFontSize(1.4)}}>
              카테고리입력
            </Text>
          ...
          <View
            ...
            <View
              ...
              <TextInput
                ...
                style={{height: '100%', fontSize: responsiveFontSize(1.4)}}
                value={title}
