...
export default function ConstructionCoNavigatorTab() {
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        name="중장비스케줄"
        component={ToolRentReqStack}
        options={{
          tabBarLabel: '중장비스케줄',
          headerShown: false,
          tabBarIcon: ({focused, size}) => (
            <Image
              style={{width: 24.64, height: 21.28}}
              source={
                focused
                  ? require('@/assets/images/10-doc/08-heavy-schedule-a.png')
                  : require('@/assets/images/10-doc/07-heavy-schedule.png')
              }
            />
          ),
        }}
      ...
      <Tab.Screen
        name="마이페이지"
        initialParams={{userType: 'construction'}}
