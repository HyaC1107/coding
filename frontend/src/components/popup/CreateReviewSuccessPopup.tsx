...
export default function CreateReviewSuccessPopup(): JSX.Element {
    ...
    <View style={showPopup ? styles.rootWrapper : styles.close}>
      <View
        ...
        <View
          ...
          <Image source={require('@assets/images/review-create-popup.png')} />
        </View>
        <View style={{width: '100%', alignItems: 'center', padding: '5%'}}>
          <Text style={{color: '#2CB07B', fontSize: 10, paddingTop: '5%'}}>
            리뷰가 등록되었습니다
          </Text>
        </View>
      </View>
