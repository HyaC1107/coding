...
export default function HeavyScheduleNavPopup(
        ...
        <View
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(1);
                // data.handleHeader('견적요청');
                navigation.navigate('HeavyVisitRequestPage');
              }}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>견적요청</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(2);
                navigation.navigate('HeavyConstructionReqestPage');
              }}>
              <View style={styles.iconWrap}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>임대요청</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(4);
                // data.handleHeader('임대스케줄');
                navigation.navigate('HeavyConstructionSchedulePage');
              }}>
              <View style={styles.iconWrap}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>임대스케줄</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(5);
                // data.handleHeader('임대취소요청');
                navigation.navigate('HeavyCancleRequestSchedulePage');
              }}>
              <View style={styles.iconWrap}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>임대취소요청</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(6);
                navigation.navigate('HeavyConstructionFinishPage');
              }}>
              <View style={styles.iconWrap}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>임대완료</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(7);
                navigation.navigate('HeavyScheduleMgmtPage');
              }}>
              <View style={styles.iconWrap}>
...
const styles = StyleSheet.create({
  ...
  text: {fontSize: responsiveFontSize(1.5)},
  divider: {
    borderWidth: 1,
    borderColor: '#F6F6F6',
    width: '85%',
