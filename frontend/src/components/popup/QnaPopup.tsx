...
export default function QnaPopup(data: ScheduleNavPopupProps): JSX.Element {
        ...
        <View
          ...
          <View style={styles.checkGroupWrap}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>1:1문의</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>업체신고</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>불편개선요청</Text>
            </View>
          </View>
        </View>
