...
export default function ConsToolRentNavPopup(
        ...
        <View
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                ...
                navigation.navigate('ToolReqestPage');
              }}>
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                ...
                navigation.navigate('GetRequestListPage');
              }}>
              <View style={styles.iconWrap}>
            ...
            <View style={styles.textWrap}>
              <Text style={styles.text}>임대견적</Text>
            </View>
          </View>
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                ...
                navigation.navigate('RentSchedulePage');
              }}>
              <View style={styles.iconWrap}>
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                ...
                navigation.navigate('UpdateRentSchedulePage');
              }}>
              <View style={styles.iconWrap}>
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(5);
                navigation.navigate('CancelRentSchedulePage');
              }}>
              <View style={styles.iconWrap}>
          ...
          <View style={styles.checkGroupWrap}>
            <TouchableWithoutFeedback
              onPress={() => {
                setCheck(6);
                navigation.navigate('RentSuccessPage');
              }}>
              <View style={styles.iconWrap}>
